...
def CURRENCOINTICKERLOWERCASEget_rpc():
    return AuthServiceProxy("http://%s:%s@%s:%s" % (
        config.CURRENCOINTICKERLOWERCASErpc_config['rpc_username'], config.CURRENCOINTICKERLOWERCASErpc_config['rpc_password'],
        config.CURRENCOINTICKERLOWERCASErpc_config['rpc_host'],
        config.CURRENCOINTICKERLOWERCASErpc_config['rpc_port']), timeout=config.CURRENCOINTICKERLOWERCASErpc_config['timeout'])		
